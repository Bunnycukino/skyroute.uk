  ...
  return (
    <div className="min-h-screen bg-gray-100 p-4 text-black">
      <div className="print:hidden flex justify-between items-center mb-4 max-w-[1000px] mx-auto">
        <Link href="/ramp" className="text-xs font-bold text-gray-600 hover:text-black">&larr; BACK TO RAMP</Link>
      ...
      <form onSubmit={handleSubmit} className="max-w-[1000px] mx-auto bg-white border-[4px] border-black shadow-2xl print:shadow-none print:border-[2px]">
        ...
        <div className="grid grid-cols-2 divide-x-2 divide-black border-b-2 border-black">
          <div className="p-4 space-y-3 bg-white">
            <div className="flex justify-between items-center"><span className="text-[10px] font-black uppercase">Locks/Seals Checked Prior to Opening?</span>
              <select className="bg-black text-white text-[10px] font-black p-1.5 rounded" value={formData.lock_seal_check} onChange={e => setFormData({...formData, lock_seal_check: e.target.value})}>
            ...
            <div className="flex justify-between items-center"><span className="text-[10px] font-black uppercase">Lock Seals Intact?</span>
              <select className="bg-black text-white text-[10px] font-black p-1.5 rounded" value={formData.lock_seal_intact} onChange={e => setFormData({...formData, lock_seal_intact: e.target.value})}>
                <option value="YES">YES</option><option value="NO">NO</option>
              </select>
            </div>
          </div>
          <div className="p-4 space-y-3 bg-white">
            <div className="flex justify-between items-center"><span className="text-[10px] font-black uppercase">Seal numbers match paperwork?</span>
              <select className="bg-black text-white text-[10px] font-black p-1.5 rounded" value={formData.seals_match_paperwork} onChange={e => setFormData({...formData, seals_match_paperwork: e.target.value})}>
                <option value="YES">YES</option><option value="NO">NO</option>
              </select>
            </div>
            <div className="flex justify-between items-center"><span className="text-[10px] font-black uppercase">C209 Present?</span>
              <select className="bg-black text-white text-[10px] font-black p-1.5 rounded" value={formData.c209_present} onChange={e => setFormData({...formData, c209_present: e.target.value})}>
                <option value="YES">YES</option><option value="NO">NO</option>
              </select>
            </div>
          </div>
        ...
        <div className="grid grid-cols-3 border-b-2 border-black divide-x-2 divide-black">
           ...
           <div className="p-4 bg-white flex flex-col justify-between">
             ...
             <input className="w-full text-xl font-black uppercase outline-none border-b border-black pb-1" value={formData.inbound_signature} onChange={e => setFormData({...formData, inbound_signature: e.target.value})} />
           </div>
        </div>
        ...
        <div className="grid grid-cols-4 border-b-2 border-black divide-x-2 divide-black">
          ...
          <div className="p-4 space-y-3 col-span-2 bg-white">
            <div className="flex justify-between items-center"><span className="text-[10px] font-black uppercase">Recorded on IB Despatch Sheet?</span>
              <select className="bg-black text-white text-[10px] font-black p-1.5 rounded" value={formData.recorded_on_dispatch} onChange={e => setFormData({...formData, recorded_on_dispatch: e.target.value})}>
                <option value="YES">YES</option><option value="NO">NO</option>
              </select>
            </div>
            <div className="flex justify-between items-center"><span className="text-[10px] font-black uppercase">Manager/Shift Leader Informed?</span>
              <select className="bg-black text-white text-[10px] font-black p-1.5 rounded" value={formData.manager_informed} onChange={e => setFormData({...formData, manager_informed: e.target.value})}>
                <option value="YES">YES</option><option value="NO">NO</option>
              </select>
            </div>
          </div>
        ...
        <div className="grid grid-cols-2 divide-x-2 divide-black border-b-2 border-black">
          <div className="p-4 space-y-3 bg-white">
            <div className="flex justify-between items-center"><span className="text-[10px] font-black uppercase">Doors/Locks Serviceable?</span>
              <select className="bg-black text-white text-[10px] font-black p-1.5 rounded" value={formData.equip_doors_locks} onChange={e => setFormData({...formData, equip_doors_locks: e.target.value})}>
                <option value="YES">YES</option><option value="NO">NO</option>
              </select>
            </div>
            <div className="flex justify-between items-center"><span className="text-[10px] font-black uppercase">Wheels/Brakes Serviceable?</span>
              <select className="bg-black text-white text-[10px] font-black p-1.5 rounded" value={formData.equip_wheels_brakes} onChange={e => setFormData({...formData, equip_wheels_brakes: e.target.value})}>
                <option value="YES">YES</option><option value="NO">NO</option>
              </select>
            </div>
          </div>
