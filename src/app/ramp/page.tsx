    ...
    <div className=\"min-h-screen bg-slate-900 flex flex-col md:flex-row\">
      <aside className=\"w-full md:w-64 bg-slate-950 p-6 flex flex-col border-r border-white/5\">
        ...
        <nav className=\"space-y-2\">
           ...
           <Link href=\"/ramp\" className=\"block p-3 rounded-lg bg-blue-600 text-white font-bold\">Ramp Input</Link>
      ...
      <main className=\"flex-1 p-4 md:p-8 overflow-y-auto\">
        <div className=\"max-w-4xl mx-auto\">
          <div className=\"mb-8\">
            ...
            <p className=\"text-slate-400 font-medium\">Register incoming containers based on Excel template</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className=\"bg-white rounded-3xl shadow-2xl overflow-hidden border border-white/10\">
             <div className=\"p-8 space-y-6\">
                ...
                <div className=\"space-y-2\">
                   ...
                   <input 
                      required
                      className=\"w-24 bg-slate-50 border-2 border-slate-100 rounded-2xl px-4 py-3 font-black text-center focus:border-blue-500 transition-all outline-none\"
                      placeholder=\"RR\"
                      maxLength={3}
